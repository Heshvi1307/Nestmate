...
export const InteractiveMap: React.FC<InteractiveMapProps> = ({
  ...
  return (
    <div className="relative w-full h-full min-h-[500px] lg:min-h-[700px] rounded-2xl overflow-hidden border border-border bg-[#ECEEEA] shadow-card select-none">
          ...
          return (
            ...
            >
              ...
              >
                ...
                >
                  <span className="tabular-nums">{formatCompactRent(prop.baseRent)}</span>
                  {prop.verified && (
