      ...
      <main className="flex-1">
        ...
        {activeTab === 'harmony-match' && (
          <div className="max-w-4xl mx-auto px-4 py-16 text-center space-y-6">
            ...
            <div className="space-y-2">
              <span className="text-xs font-bold text-teal-400 uppercase tracking-wider">Pillar 2 Architecture Ready</span>
              <h2 className="text-3xl font-extrabold text-white">HarmonyMatch: Multi-Dimensional Housemate Fit</h2>
              <p className="text-slate-400 max-w-xl mx-auto text-sm">
                Matches co-living roommates using weighted Cosine Vector Distance across sleep cycles, cleanliness levels, guest rules, and generates automated Flatmate Living Charters.
              </p>
            </div>
            <div className="p-6 glass-panel rounded-2xl border border-slate-800 text-left max-w-lg mx-auto space-y-3">
              ...
              <ul className="text-xs text-slate-400 space-y-1.5 list-disc list-inside">
                <li>60-second interactive lifestyle vector quiz</li>
                <li>Radar spider-chart comparing User A vs User B</li>
                <li>Auto-generated downloadable Roommate Pact (PDF)</li>
              </ul>
              <button
        ...
        {activeTab === 'snapfix' && (
          <div className="max-w-4xl mx-auto px-4 py-16 text-center space-y-6">
            ...
            <div className="space-y-2">
              <span className="text-xs font-bold text-teal-400 uppercase tracking-wider">Pillar 3 Architecture Ready</span>
              <h2 className="text-3xl font-extrabold text-white">SnapFix: Vision Maintenance & Damage Triage</h2>
              <p className="text-slate-400 max-w-xl mx-auto text-sm">
                Computer-vision damage severity scoring, localized repair cost estimation, and timestamped move-in inspection logs to protect security deposits.
              </p>
            </div>
            <div className="p-6 glass-panel rounded-2xl border border-slate-800 text-left max-w-lg mx-auto space-y-3">
              <div className="text-xs font-semibold text-slate-300 flex items-center gap-2">
              ...
              <ul className="text-xs text-slate-400 space-y-1.5 list-disc list-inside">
                <li>Multi-modal damage classifier (Urgent vs Routine)</li>
                <li>Fair repair price index in INR</li>
                <li>One-click contractor dispatch WhatsApp ticket</li>
              </ul>
              <button
                onClick={() => setActiveTab('lease-guard')}
                className="mt-2 w-full py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-xl text-xs font-bold transition-all"
