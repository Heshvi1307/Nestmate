# Public Case 5: Mumbai Standard Leave & License Agreement
> **Jurisdiction:** Mumbai, Maharashtra (Maharashtra Rent Control Act, 1999)  
> **Expected RentFair Verdict:** `SAFE`  
> **Target Safety Score:** `90-95 / 100`  

---

### Benchmark Case Summary
Standard registered Leave & License agreement: 2-month deposit (INR 90,000), society maintenance paid by owner, 24-hour advance daylight inspection notice, and mutual 1-month notice termination.

---

### Agreement Full Text
```text
LEAVE AND LICENSE AGREEMENT (MAHARASHTRA RENT CONTROL ACT FORMAT)
